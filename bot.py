...
ABOUT_TEXT = """
- **Bot :** `Song Downloader`
- **Creator :** [TMC_BOTx](https://t.me/TMC_CHANNEL_BOTX)
- **Support :** [TMC_BOTX](https://t.me/TMC_BOTX)
...
def a(client, message):
    ...
    try:
        ...
        print(str(e))
        return
    m.edit("`I AM...Uploading To TMC now... Please Wait...`")
    try:
        ...
        m.edit('**Something Went Wrong Report This at @TMC_BOTX!!**')
        print(e)
    try:
